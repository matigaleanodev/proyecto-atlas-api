...
namespace ProyectoAtlas.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260514002411_AddDocumentationResourceMetadata")]
    partial class AddDocumentationResourceMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoAtlas.Domain.Documentations.DocumentationResource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("DocumentationId", "NormalizedTitle", "NormalizedUrl", "Kind")
                        .IsUnique();

                    b.ToTable("documentation_resources", (string)null);
                });
            ...
            modelBuilder.Entity("ProyectoAtlas.Domain.Documentations.DocumentationVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ProyectoAtlas.Domain.Projects.ProjectRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SourceProjectId", "TargetProjectId", "Kind")
                        .IsUnique();
