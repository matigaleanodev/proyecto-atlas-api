...
using ProyectoAtlas.Infrastructure.Audit;
using ProyectoAtlas.Infrastructure.DocumentationRelations;
using ProyectoAtlas.Infrastructure.DocumentationResources;
...
builder.Services.AddScoped<GetProjectActivityFeedQueryHandler>();
...
builder.Services.AddScoped<ListDocumentationAuditEventsQueryHandler>();
builder.Services.AddScoped<GetDocumentationActivityFeedQueryHandler>();
builder.Services.AddScoped<CreateProjectReleaseNotesCommandHandler>();
builder.Services.AddScoped<ListProjectReleaseNotesQueryHandler>();
builder.Services.AddScoped<GetProjectReleaseNotesBySlugQueryHandler>();
builder.Services.AddScoped<UpdateProjectReleaseNotesCommandHandler>();
builder.Services.AddScoped<DeleteProjectReleaseNotesCommandHandler>();
...
builder.Services.AddScoped<DeleteDocumentationResourceCommandHandler>();
builder.Services.AddScoped<CreateFeatureDocumentationLinkCommandHandler>();
builder.Services.AddScoped<ListFeatureDocumentationLinksQueryHandler>();
builder.Services.AddScoped<ListDocumentationFeatureLinksQueryHandler>();
builder.Services.AddScoped<DeleteFeatureDocumentationLinkCommandHandler>();
...
builder.Services.AddScoped<CreateProjectMilestoneCommandHandler>();
builder.Services.AddScoped<ListProjectMilestonesQueryHandler>();
...
builder.Services.AddScoped<IProjectActivityFeedRepository, ProjectActivityFeedRepository>();
...
builder.Services.AddScoped<IDocumentationActivityFeedRepository, DocumentationActivityFeedRepository>();
